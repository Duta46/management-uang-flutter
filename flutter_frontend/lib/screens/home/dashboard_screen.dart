...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void didChangeDependencies() {
    ...
    // Refresh data whenever the widget rebuilds with new dependencies
    _loadInitialData();
  }
  ...
  Future<void> _loadInitialData() async {
    ...
    final financialSummaryProvider = Provider.of<FinancialSummaryProvider>(
      context,
      listen: false,
    );
    ...
    await Future.wait([
      transactionProvider.fetchTransactions(
        forceRefresh: true, // Selalu refresh data untuk memastikan saldo terbaru
      ),
      financialSummaryProvider.getMonthlyFinancialData(
        DateTime.now().year,
      ), // Load financial summary
    ]);
  }

  // Method untuk refresh data ketika kembali dari layar transaksi
  Future<void> _refreshData() async {
    ...
    await Future.wait([
      ...
      financialSummaryProvider.getMonthlyFinancialData(DateTime.now().year),
    ]);
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (financialSummaryProvider.currentMonthSummary != null) {
      ...
      monthlyExpense =
          financialSummaryProvider.currentMonthSummary!.totalExpense;
      monthlyNetTotal = financialSummaryProvider.currentMonthSummary!.netTotal;
      monthlyTotalSaving =
          financialSummaryProvider.currentMonthSummary!.totalSaving;
    }
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSummaryCards(
              ...
              netTotalBgColor: monthlyNetTotal >= 0
                  ? const Color(0xFFe8f5e9)
                  : const Color(0xFFffebee),
              netTotalIconColor: monthlyNetTotal >= 0
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () async {
                    // Navigate to transactions screen and refresh data when returning
                    ...
                    // Refresh data after returning from transaction list screen
                    final transactionProvider = Provider.of<TransactionProvider>(context, listen: false);

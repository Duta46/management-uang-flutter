                      ...
                      pw.Table(
                        ...
                        children: [
                          ...
                          ...budgetComparison.map((item) {
                            ...
                            final budgeted = double.tryParse(item['budgeted'].toString() ?? '0') ?? 0;
                            final spent = double.tryParse(item['spent'].toString() ?? '0') ?? 0;
                            final percentage = double.tryParse(item['percentage_used'].toString() ?? '0') ?? 0;
                            ...
                            return pw.TableRow(
                              children: [
                                ...
                                pw.Padding(
                                  padding: pw.EdgeInsets.all(5),
                                  child: pw.Text(
                                    'Rp ${NumberFormat('#,###').format(budgeted)}',
                                    style: pw.TextStyle(fontSize: 9),
                                    textAlign: pw.TextAlign.right,
                                  ),
                                ),
                                ...
                                pw.Padding(
                                  ...
                                  child: pw.Text(
                                    ...
                                    style: pw.TextStyle(
                                      fontSize: 9,
                                      color: percentage > 100 ? PdfColors.red : PdfColors.green,
                                    ),
                                    textAlign: pw.TextAlign.right,
                                  ),
                                ),
